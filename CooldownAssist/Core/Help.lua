...
local LINES = {
    ...
    "  |cff00ff00/ca list|r — list watched (used) spells",
    "  |cff00ff00/ca on <name|id>|r — enable tracking for a spell",
    "  |cff00ff00/ca off <name|id>|r — disable tracking for a spell",
    "  |cff00ff00/ca scan|r — refresh watched cooldowns (does not add unused spells)",
    "  |cff00ff00/ca rebuild|r — forget used cooldowns and start over",
...
function Help.PrintAbout()
    ...
    print("  Speaks when used cooldowns become ready, charges gain, and matched buffs fade.")
    print("  Watches a cooldown only after you use that spell or item (not unused bar / spellbook entries).")
