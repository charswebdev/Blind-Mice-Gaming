...
local function Start()
    ...
    print("|cff00ff00[BMG Unit Frames]|r v0.7.1 loaded. Interface: " .. tostring(iface))
    print("|cff00ff00[BMG Unit Frames]|r |cff00ff00/bmguf|r settings · Key Bindings: Open settings")
end
