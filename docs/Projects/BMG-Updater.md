...
- **2026-09-17:** catalog lists **five** BMG Unit Frames packages. Forever is **1.1.1** (`16001` plus `121500` / `121000`) and installs into `_classic_beta_` (live ForeverBeta), then `_forever_` / `_wow_forever_` / `_camelot_`. Players refresh the catalog from `main`. The shipped 1.2.0 exe needs a local `app.py` that includes that Forever folder list.
