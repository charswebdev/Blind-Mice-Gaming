...
-- Blizzard-style Situations categories adapted for LPL Conditions rules.
...
LPL.ConditionDefs.LOCATIONS = {
    ...
    { key = "housing", label = "Player Housing" },
...
LPL.ConditionDefs.LINK_TYPES = {
    ...
    { key = "pvpTalent", label = "PvP Talents", badge = "PVP" },
    { key = "actionBar", label = "Action Bars", badge = "BARS" },
    { key = "equipment", label = "Equipment", badge = "GEAR" },
    { key = "cooldownManager", label = "Cooldown Manager", badge = "CDM" },
...
LPL.ConditionDefs.DIFFICULTIES = {
    ...
    arena = {
        { id = 0, label = "Any arena" },
    },
    battleground = {
        { id = 0, label = "Any battleground" },
    },
    scenario = {
        { id = 0, label = "Any scenario" },
    },
    delve = {
        { id = 0, label = "Any delve" },
    },
}
