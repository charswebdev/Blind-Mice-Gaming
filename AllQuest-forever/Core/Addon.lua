...
AQ.version = "1.0.0"
AQ.title = "AllQuest - WoW Forever"
AQ.Logo = "Interface\\AddOns\\AllQuest-forever\\Media\\AllQuestLogo"

local MEDIA = "Interface\\AddOns\\AllQuest-forever\\Media\\"
AQ.Media = {
    Icons = {
...
function AQ:Print(msg)
    ...
    print("|cffffeb66[AllQuest Forever]|r " .. msg)
end
