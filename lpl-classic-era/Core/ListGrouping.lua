...
function LPL.ListGrouping:GetCollapsedStorage(listKey)
    ...
    LPLClassicEraDB.listCollapsed = LPLClassicEraDB.listCollapsed or {}
    LPLClassicEraDB.listCollapsed[listKey] = LPLClassicEraDB.listCollapsed[listKey] or {}
    return LPLClassicEraDB.listCollapsed[listKey]
end
