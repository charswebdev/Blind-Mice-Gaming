...
local TAB_DEFINITIONS = {
    ...
    },
    {
        id = "talents",
        label = "Talents",
        description = "Plan Classic Era talent builds (3 trees, 51 points).",
        iconStem = "talents_64",
        order = 20,
        bottom = false,
    },
    ...
    },
    {
        id = "editmode",
        label = "Edit Mode",
        description = "Save and activate Blizzard HUD Edit Mode layouts.",
    ...
    },
    {
        id = "builds",
        label = "Import / Export",
        description = "Import and export Classic Era LPL loadouts and sets.",
        iconStem = "import_64",
        order = 90,
        bottom = true,
    },
