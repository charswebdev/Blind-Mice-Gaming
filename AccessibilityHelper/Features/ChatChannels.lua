...
Chat.CHANNELS = {
    ...
    { key = "chatSay", label = "Say", event = "CHAT_MSG_SAY", kind = "spoken", chatType = "SAY", section = "Nearby",
        example = "Bob says: Hello there." },
    { key = "chatYell", label = "Yell", event = "CHAT_MSG_YELL", kind = "spoken", chatType = "YELL", section = "Nearby",
        example = "Bob yells: Help!" },
    { key = "chatEmote", label = "Emote", event = "CHAT_MSG_EMOTE", kind = "exact", section = "Nearby",
        example = "Bob waves at you." },
    { key = "chatTextEmote", label = "Text emote", event = "CHAT_MSG_TEXT_EMOTE", kind = "exact", section = "Nearby",
        example = "You wave at Bob." },
    { key = "chatWhisper", label = "Whisper", event = "CHAT_MSG_WHISPER", kind = "spoken", chatType = "WHISPER", section = "Whispers",
        example = "Bob whispers: Want to group?" },
    { key = "chatWhisperOut", label = "Whisper (outgoing)", event = "CHAT_MSG_WHISPER_INFORM", kind = "spoken", chatType = "WHISPER_INFORM", section = "Whispers",
        example = "To Bob: Sure." },
    { key = "chatBNWhisper", label = "Blizzard Whispers", event = "CHAT_MSG_BN_WHISPER", kind = "spoken", chatType = "BN_WHISPER", section = "Whispers",
        example = "Friend whispers: Are you on?" },
    { key = "chatBNWhisperOut", label = "Blizzard Whispers (outgoing)", event = "CHAT_MSG_BN_WHISPER_INFORM", kind = "spoken", chatType = "BN_WHISPER_INFORM", section = "Whispers",
        example = "To Friend: Yes." },
    { key = "chatParty", label = "Party", event = "CHAT_MSG_PARTY", kind = "spoken", chatType = "PARTY", section = "Groups",
        example = "Bob says: Ready?" },
    { key = "chatPartyLeader", label = "Party Leader", event = "CHAT_MSG_PARTY_LEADER", kind = "spoken", chatType = "PARTY_LEADER", section = "Groups",
        example = "Bob says: Stack on me." },
    { key = "chatRaid", label = "Raid", event = "CHAT_MSG_RAID", kind = "spoken", chatType = "RAID", section = "Groups",
        example = "Bob says: Bloodlust now." },
    { key = "chatRaidLeader", label = "Raid Leader", event = "CHAT_MSG_RAID_LEADER", kind = "spoken", chatType = "RAID_LEADER", section = "Groups",
        example = "Bob says: Kill adds." },
    { key = "chatRaidWarning", label = "Raid Warning", event = "CHAT_MSG_RAID_WARNING", kind = "spoken", chatType = "RAID_WARNING", section = "Groups",
        example = "Bob says: Spread out!" },
    { key = "chatInstance", label = "Instance", event = "CHAT_MSG_INSTANCE_CHAT", kind = "spoken", chatType = "INSTANCE_CHAT", section = "Groups",
        example = "Bob says: First boss." },
    { key = "chatInstanceLeader", label = "Instance Leader", event = "CHAT_MSG_INSTANCE_CHAT_LEADER", kind = "spoken", chatType = "INSTANCE_CHAT_LEADER", section = "Groups",
        example = "Bob says: Interrupt." },
    { key = "chatGuild", label = "Guild", event = "CHAT_MSG_GUILD", kind = "spoken", chatType = "GUILD", section = "Groups",
        example = "Bob says: Anyone for M+" },
    { key = "chatOfficer", label = "Officer", event = "CHAT_MSG_OFFICER", kind = "spoken", chatType = "OFFICER", section = "Groups",
        example = "Bob says: Promote Sue." },
    { key = "chatGuildAnnounce", label = "Guild Announce", event = "CHAT_MSG_GUILD_ACHIEVEMENT", kind = "exact", section = "Groups",
        example = "Bob has earned the achievement Keystone Hero." },
    { key = "chatGuildAnnounce", label = "Guild Announce (item)", event = "CHAT_MSG_GUILD_ITEM_LOOTED", kind = "exact", section = "Groups", hideInSettings = true,
        example = "Bob has looted Thunderfury." },
    { key = "chatAchievement", label = "Achievement Announce", event = "CHAT_MSG_ACHIEVEMENT", kind = "exact", section = "Groups",
        example = "Bob has earned the achievement Exploring Kalimdor." },
    { key = "chatCommunities", label = "Communities", event = "CHAT_MSG_COMMUNITIES_CHANNEL", kind = "channel", chatType = "CHANNEL", section = "Groups",
        example = "[My Community] Bob: Raid tonight." },
    { key = "chatAFK", label = "AFK replies", event = "CHAT_MSG_AFK", kind = "spoken", chatType = "AFK", section = "Whispers",
        example = "Bob is Away from Keyboard: Away from keyboard." },
    { key = "chatDND", label = "DND replies", event = "CHAT_MSG_DND", kind = "spoken", chatType = "DND", section = "Whispers",
        example = "Bob does not wish to be disturbed: Do not disturb." },
    { key = "chatVoiceText", label = "Voice chat text", event = "CHAT_MSG_VOICE_TEXT", kind = "spoken", chatType = "VOICE_TEXT", section = "Nearby",
    ...
    -- Profession and leftover chat with no other AH owner (Loot / Progress / Money stay on their tabs)
    { key = "chatTradeskills", label = "Tradeskills", event = "CHAT_MSG_TRADESKILLS", kind = "exact", section = "Crafting",
        selfOnly = true, example = "You create Linen Cloth." },
    { key = "chatOpening", label = "Gathering and opening", event = "CHAT_MSG_OPENING", kind = "exact", section = "Crafting",
        selfOnly = true, example = "You perform Herb Gathering on Silverleaf." },
    { key = "chatPetInfo", label = "Pet Info", event = "CHAT_MSG_PET_INFO", kind = "exact", section = "Pet",
        example = "Your pet is happy." },
    { key = "chatMiscInfo", label = "Combat log extras", event = "CHAT_MSG_COMBAT_MISC_INFO", kind = "exact", section = "System",
    ...
    { key = "chatPetBattleCombat", label = "Pet Battle Combat", event = "CHAT_MSG_PET_BATTLE_COMBAT_LOG", kind = "exact", section = "Pet",
        example = "Your pet hits for 120." },
    { key = "chatPetBattleInfo", label = "Pet Battle Info", event = "CHAT_MSG_PET_BATTLE_INFO", kind = "exact", section = "Pet",
...
function Chat.SettingsRows()
    local sectionOrder = { "Social", "Nearby", "Groups", "Whispers", "Creature", "Crafting", "Pet", "PvP", "Other" }
    local sectionLabels = {
        Social = "Town and trade",
        Nearby = "Nearby talk",
        Groups = "Groups",
        Whispers = "Whispers",
        Creature = "Creatures",
