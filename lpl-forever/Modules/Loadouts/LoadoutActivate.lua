...
local function ApplyNonTalentSegments(set)
    ...
    run("PvP", "pvpTalentSetIDs", LPL.PvpTalentActivate and function(id)
        return LPL.PvpTalentActivate:ApplySet(id)
    end)
    ...
    run("Cooldown Manager", "cooldownManagerSetIDs", LPL.CooldownManagerActivate and function(id)
        return LPL.CooldownManagerActivate:ApplySet(id)
    end)
