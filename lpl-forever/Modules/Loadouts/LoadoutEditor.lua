...
local SEGMENTS = {
    {
        ...
        label = "Talents",
        getAll = function()
            return LPL.BuildStore and LPL.BuildStore:GetAll() or {}
        end,
        get = function(id)
            return LPL.BuildStore and LPL.BuildStore:Get(id)
        end,
        getSummary = function(record)
            return LPL.BuildStore and LPL.BuildStore:GetSummaryLine(record) or ""
        end,
        getClassID = function(record)
            return record and tonumber(record.classID)
        end,
    ...
    {
        field = "pvpTalentSetIDs",
        singular = "pvpTalentSetID",
        label = "PvP Talents",
        getAll = function()
            return LPL.PvpTalentStore and LPL.PvpTalentStore:GetAll() or {}
        end,
        get = function(id)
            return LPL.PvpTalentStore and LPL.PvpTalentStore:Get(id)
        end,
        getSummary = function(record)
            return LPL.PvpTalentStore and LPL.PvpTalentStore:GetSummaryLine(record) or ""
        end,
        getClassID = function(record)
            return LPL.PvpTalentStore and LPL.PvpTalentStore:GetEffectiveClassID(record)
        end,
        getSpecID = function(record)
            return LPL.PvpTalentStore and LPL.PvpTalentStore:GetEffectiveSpecID(record)
        end,
    },
    {
        field = "cooldownManagerSetIDs",
        singular = "cooldownManagerSetID",
        label = "Cooldown Manager",
        getAll = function()
            return LPL.CooldownManagerStore and LPL.CooldownManagerStore:GetAll() or {}
        end,
        get = function(id)
            return LPL.CooldownManagerStore and LPL.CooldownManagerStore:Get(id)
        end,
        getSummary = function(record)
            return LPL.CooldownManagerStore and LPL.CooldownManagerStore:GetSummaryLine(record) or ""
        end,
        getClassID = function(record)
            return LPL.CooldownManagerStore and LPL.CooldownManagerStore:GetEffectiveClassID(record)
        end,
        getSpecID = function(record)
            return LPL.CooldownManagerStore and LPL.CooldownManagerStore:GetEffectiveSpecID(record)
        end,
    },
    {
...
local function ResolveIcon(stem)
    ...
    return "Interface\\AddOns\\lpl-forever\\icons\\" .. stem .. ".tga"
end
