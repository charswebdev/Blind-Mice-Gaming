...
-- GetNumClasses() is a count, not a max ID. Forever/classic-style holes
-- (no Death Knight = 6) sit below later IDs such as Druid (11).
local function MaxClassID()
