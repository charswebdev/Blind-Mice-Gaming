...
function LPL.ListGrouping:GetCollapsedStorage(listKey)
    ...
    LPLForeverDB.listCollapsed = LPLForeverDB.listCollapsed or {}
    LPLForeverDB.listCollapsed[listKey] = LPLForeverDB.listCollapsed[listKey] or {}
    return LPLForeverDB.listCollapsed[listKey]
end
