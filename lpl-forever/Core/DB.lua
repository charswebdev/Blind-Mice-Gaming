...
function LPL.DB:Initialize()
    if _G.LPLForeverDB == nil then
        _G.LPLForeverDB = {}
    end
    LPLForeverDB = _G.LPLForeverDB
    MergeDefaults(LPLForeverDB, DEFAULTS)
    self.data = LPLForeverDB
...
function LPL.DB:SyncFromGlobal()
    if _G.LPLForeverDB then
        self.data = _G.LPLForeverDB
    end
end
